...
class TestInsertJob:
    ...
    def test_id_increments(self, db_path: Path, sample_job: JobResultCreate, failed_job: JobResultCreate):
...
class TestGetJobs:
    ...
    def test_newest_first_ordering(self, db_path: Path, sample_job: JobResultCreate, failed_job: JobResultCreate):
        insert_job(sample_job, db_path=db_path)
